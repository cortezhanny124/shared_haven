  ...
  Widget build(BuildContext context) {
    return DropdownButtonFormField(
      ...
      items: extractedData.map((data) {
        ...
        final aliases = (data['fingerprints'] as List<dynamic>).map<String>((
          fp,
        ) {
        ...
        return DropdownMenuItem<Map<String, dynamic>>(
          ...
          child: Text(
            ...
            "${data['type'].contains('RELATIVETIMELOCK')
                ? 'OLDER: ${data['timelock']} ${AppLocalizations.of(rootContext)!.translate('blocks')}'
                : data['type'].contains('ABSOLUTETIMELOCK')
                ? 'AFTER: ${data['timelock']} ${AppLocalizations.of(rootContext)!.translate('height')}'
                : 'MULTISIG'}, "
